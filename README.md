...
To update the database use this command from the Web project folder (replace `PrecioAPP` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../PrecioAPP.Infrastructure/PrecioAPP.Infrastructure.csproj -s PrecioAPP.Web.csproj
```
